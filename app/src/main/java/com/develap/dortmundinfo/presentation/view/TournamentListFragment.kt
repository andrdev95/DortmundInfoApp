...
import com.develap.dortmundinfo.databinding.FragmentTournamentListBinding
...
class TournamentListFragment : Fragment() {
    ...
    private val viewModel: TournamentListFragmentViewModel by lazy {
        ViewModelProvider(this)[TournamentListFragmentViewModel::class.java]
    }
